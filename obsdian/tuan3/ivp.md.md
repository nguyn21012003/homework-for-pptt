- [[#Hàm f(t,y)|Hàm f(t,y)]]
- [[#Nghiệm giải tích|Nghiệm giải tích]]
- [[#Phương pháp Euler|Phương pháp Euler]]
- [[#Phương pháp Euler - cải tiến(Modified Euler)|Phương pháp Euler - cải tiến(Modified Euler)]]
- [[#Phương pháp Runge-Kutta 2(phương pháp midpoints)|Phương pháp Runge-Kutta 2(phương pháp midpoints)]]
- [[#Phương pháp Runge-Kutta 3|Phương pháp Runge-Kutta 3]]
- [[#Function để giải hàm f(t,y)|Function để giải hàm f(t,y)]]
				- [[#Mô tả:|Mô tả:]]
				- [[#Trong đó:|Trong đó:]]
- [[#Hàm để plot|Hàm để plot]]
				- [[#Mô tả:|Mô tả:]]
- [[#Hàm để ghi file|Hàm để ghi file]]
- [[#Kết quả|Kết quả]]
...
```
![Gnu-plot](numericalmethod.gnuplot.pdf)